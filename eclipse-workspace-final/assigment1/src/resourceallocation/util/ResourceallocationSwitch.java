 ...
 * @generated
 */
public class ResourceallocationSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public ResourceallocationSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ResourceallocationPackage.BACHELOR: {
				Bachelor bachelor = (Bachelor)theEObject;
				T result = caseBachelor(bachelor);
			...
			case ResourceallocationPackage.SPECIALTY: {
				Specialty specialty = (Specialty)theEObject;
				T result = caseSpecialty(specialty);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Bachelor</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Bachelor</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBachelor(Bachelor object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Specialty</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Specialty</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSpecialty(Specialty object) {
		return null;
	}
